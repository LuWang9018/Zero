...
export declare class Day extends React.PureComponent<CombinedProps, never> {
    private dayNode;
    componentDidUpdate(prevProps: CombinedProps): void;
    render(): JSX.Element;
    private setNode;
}
declare const _default: React.ComponentClass<Props, React.ComponentState> & typeof Day;
