...
export class BulkActions extends React.PureComponent {
    ...
    render() {
        ...
        const cancelButton = (<button className={cancelButtonClassName} 
        // eslint-disable-next-line react/jsx-no-bind
        onClick={this.setSelectMode.bind(this, false)} testID="btn-cancel" disabled={disabled}>
        ...
        const promotedActionsMarkup = promotedActions && numberOfPromotedActionsToRender > 0
            ? [...promotedActions]
                ...
                .map((action, index) => (<BulkActionButton {...action} key={index} handleMeasurement={this.handleMeasurement} disabled={disabled}/>))
            : null;
        ...
        {(status) => {
            ...
            return (<div className={smallScreenGroupClassName}>
              <div className={styles.ButtonGroup}>
                <CSSTransition in={selectMode} timeout={Duration.Base} classNames={slideClasses} appear>
